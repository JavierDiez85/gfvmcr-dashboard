...
const MENU_PERMS = {
  ...
  terminales: { label:'🖥️ Terminales', subs:[
    ...
    {id:'tpv_agentes',label:'Comisiones Agentes'},{id:'tpv_terminales',label:'Por Cliente'},{id:'tpv_cambios',label:'Cambios de Terminal'},{id:'tpv_historial',label:'Historial de Pagos'},
  ]},
